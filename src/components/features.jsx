            ...
            <div className="container mx-auto px-3 md:px-10">
                ...
                <BentoTilt className="border-hsla relative mb-7 h-96 w-full overflow-x-hidden rounded-md  md:h-[65vh]">
                    <BentoCard
                        ...
                        description={
                            "A cross-platform metagame app, turning your activities across Web2 and Web3 games into a rewarding adventure.s"
                        }
                        isComingSoon
                    />
                </BentoTilt>
                <div className="grid grid-cols-2 h-[135vh] grid-rows-3 gap-4">
                    ...
                    <BentoTilt className=" bento-tilt_1 row-span-1 md:col-span-1 ms-32 md:ms-0 md:row-span-1">
                        <BentoCard
                    ...
                    <BentoTilt className="bento-tilt_1 row-span-1 me-14 md:me-0  md:col-span-1">
                        <BentoCard
